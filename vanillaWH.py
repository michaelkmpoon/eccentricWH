...
def drift(sim_jacobi, sim, object_num, h):
    ...
    rx, ry, rz, vx, vy, vz = sim_jacobi[object_num, :6]
    ...
    sim_jacobi[object_num, 0] = f*rx + g*vx
    sim_jacobi[object_num, 1] = f*ry + g*vy
    sim_jacobi[object_num, 2] = f*rz + g*vz
    sim_jacobi[object_num, 3] = fd*rx + gd*vx
    sim_jacobi[object_num, 4] = fd*ry + gd*vy
    sim_jacobi[object_num, 5] = fd*rz + gd*vz
